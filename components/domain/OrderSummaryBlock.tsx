...
export function OrderSummaryBlock({ items, totalAmount }: { items: OrderItemRow[]; totalAmount: number }) {
  return (
    <section aria-labelledby="order-summary-heading" className="rounded-lg border border-slate-200 bg-white p-4">
      <h2 id="order-summary-heading" className="text-sm font-semibold text-slate-500">
        รายการสินค้า
      </h2>
