-- 0016_transform_province_alias.sql
-- Rewrite transform_pending_orders province lookup to resolve via
-- analytics.dim_geo_alias (0015) instead of matching dim_geo.province_name_th
-- directly, with TH-XX fallback. Applied via MCP 2026-08-10; backfilled
-- 2026-08-11. NOTE: superseded by 0019 (case-insensitive channel lookup) and
-- 0020 (profit margin 20%) — kept as historical record of what was applied.
