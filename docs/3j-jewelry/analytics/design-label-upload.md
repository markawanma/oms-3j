...
> ผู้ออกแบบ: architect (Yoda) · 28 ส.ค. 2569 · สถานะ: **เจ้าของเคาะครบ 4 ข้อแล้ว — approved**
>
> **คำตัดสินเจ้าของ (28 ส.ค.):**
> 1. เคสมั่นใจ → **เติมอัตโนมัติ** (มีกำแพง TH-XX + revert)
> 2. Retention = **180 วัน** (ไม่ใช่ 90)
> 3. ไฟล์เป็น **PDF ล้วน** — ไม่ต้องทำ OCR
> 4. 🔴 **ใบเก่า ม.ค.–ก.ค. โหลดจาก Seller Center ไม่ได้แล้ว** ⇒ backlog ~2,400 ออเดอร์
>    เติมย้อนหลังไม่ได้ถาวร (เหลือแค่ไฟล์ที่ค้างในเครื่อง ~15 ออเดอร์) —
>    **คุณค่าหลักของระบบ = go-forward**: เก็บใบทุกวันตั้งแต่นี้ไป จังหวัดจะครบเอง
>    ⚠️ ใบเดือน ส.ค. (328 ออเดอร์ TH-XX) อาจยังโหลดได้บางส่วน — เจ้าของควรรีบโหลดก่อนหมดอายุ
