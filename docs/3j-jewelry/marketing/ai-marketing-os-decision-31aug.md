# AI Marketing OS — มติที่ประชุม C-level + แผน 90 วัน (31 ส.ค. 2569)
...
11. Experiment ที่สอง: "คลิปเย็นดันไลฟ์" (สลับวันมี/ไม่มี วัด viewer→order) — ต่อเมื่อข้อ 10 สำเร็จ
    > ⚠️ **เจ้าของกลับมติ 16 ก.ย. 69**: ดึงมาทำ **ต.ค. 69** เลย ในรูป "สลับสัปดาห์" (W1 W3 W5 คลิปก่อนไลฟ์ · W2 W4 โพสต์เช้า) **โดยไม่รอข้อ 10** — วัดด้วย log หลังไลฟ์ที่เจ้าของจด (R5) แทน daily ingestion · รายละเอียด `content-calendar/2026-10.md` แคมเปญ #1 · ต.ค. ได้แค่ "จับตา" (n≈2 คืน/ฝั่ง/สัปดาห์) ต้องต่อ พ.ย. ถึงสรุป
...
2. SKU 2 ระบบแยก 100% (Insight 303 / Wix 290) → Insight เป็นเจ้าของ (เจ้าของเคาะแล้ว 31 ส.ค.)
...
## 8. คำถามถึงเจ้าของ — **ตอบแล้ว 31 ส.ค.**
