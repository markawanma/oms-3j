...
## 8. คำถามถึงเจ้าของ (3 ข้อ — จาก C-level โดยตรง)

1. **(CMO)** ขอ list คู่แข่งที่ไลฟ์ชนเวลาเรา 5 ชื่อ — คนยืนไลฟ์ทุกคืนรู้ดีกว่าทุก tool (10 นาที)
2. **(CMO/COO)** หลังจบไลฟ์ กรอก 3 ตัวเลข (viewer สูงสุด/ออเดอร์/ยอด) ไหวไหม —
   ตัดสินทั้ง daily brief และ experiment "คลิปดันไลฟ์"
3. **(CFO)** ยอดยิงแอดจริง/เดือน (นอกระบบ) — ใน DB มีแค่ ฿500 สัปดาห์เดียว
   ถ้ายิงจริงมากกว่านี้ = ไม่ได้บันทึก และต้องรู้เลขจริงก่อนตัดสินเสา Ads
