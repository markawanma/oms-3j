...
| `content-calendar/` | ปฏิทินโพสต์รายเดือนแบบชุนหลี (เจ้าของสั่ง 16 ก.ย. 69) — แม่แบบ `TEMPLATE.md` (ต้นฉบับ = md ใน repo, artifact = หน้าอ่าน) · ฉบับรายเดือนตั้งชื่อ ปี-เดือน — ฉบับแรก `2026-10.md` (ร่าง 1 CMO 16 ก.ย. รอเจ้าของเคาะ Q1–Q6 ก่อน Bail ทำ §6) · ทุกโพสต์ผูก `campaign_step.id` = execution log |
