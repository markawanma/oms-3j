# INDEX — docs/3j-jewelry (ปรับปรุง 29 ส.ค. 2569)
...
| ไฟล์ | คือ |
|---|---|
| `ai-marketing-os-decision-29aug.md` | 🔝 มติ C-level + แผน 90 วัน — **ทิศทางใหญ่สุดตอนนี้** |
...
## ⛔ _archive/ — ย้ายมา 29 ส.ค. เพราะอะไร
| ไฟล์ | เหตุที่ถูกถอน |
|---|---|
