...
| `oms/design-own-production-costing.md` | **เครื่องคิดต้นทุนสำหรับผลิตเอง** 19 ก.ย. 69 — เจ้าของสั่งเอง: เอาเครื่องคิด OEM มาวาง **ตัดชั้นราคาขายทิ้งทั้งชั้น** (ไม่เอา margin/floor) · สเปคผูกกับ SKU กรอกครั้งเดียว · ติ๊ก "แบบใหม่" = คิดค่าแบบเต็ม ไม่ติ๊ก = ศูนย์ | ⏳ 0140 กำลังเขียน |
